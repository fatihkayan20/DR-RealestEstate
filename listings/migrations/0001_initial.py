# Generated by Django 3.0 on 2020-08-17 17:51
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sales_type', models.CharField(choices=[('For Sale', 'For Sale'), ('For Rent', 'For Rent')], default='For Sale', max_length=50)),
                ('price', models.IntegerField()),
                ('bedrooms', models.IntegerField()),
                ('bathrooms', models.DecimalField(decimal_places=1, max_digits=2)),
                ('home_type', models.CharField(choices=[('House', 'House'), ('KONDO', 'Kondo'), ('TOWNHOUSE', 'Townhouse')], default='House', max_length=50)),
